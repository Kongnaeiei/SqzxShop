...
<body>
                        ...
                        <div class="tab-content py-2" id="v-pills-tabContent">
                            <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
                                ...
                                <div
                                    ...
                                    <div class="">
                                        <img src="https://www.checkraka.com/uploaded/img/content/130026/aungpao_truewallet_01.jpg" class="img-fluid" alt="">
                                    </div>
                                </div>
    ...
    <div class="container">
        Copyright &copy; 2022 Haiter Cloud <a class="footer-text text-black" href="https://discord.gg/dVBevNVz">ติดต่อเจ้าของร้านไม่ได้ / แจ้งปัญหาร้านค้าโกง
        <div class="float-end">
            ...
            <a class="social-button bfacebook" href="https://htcd.online/"><i class="fab fa-dev"></i></a>
        </div>
    </div>
